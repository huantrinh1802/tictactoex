defmodule TicTacToexWeb.Router do
  ...
  import TicTacToexWeb.UserAuth

  pipeline :browser do
    plug(:accepts, ["html"])
    plug(:fetch_session)
    plug(:fetch_live_flash)
    plug(:put_root_layout, html: {TicTacToexWeb.Layouts, :root})
  ...
  scope "/", TicTacToexWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TicTacToexWeb.UserAuth, :redirect_if_user_is_authenticated}],
      layout: {TicTacToexWeb.Layouts, :unauthenticated} do
  ...
  scope "/", TicTacToexWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{TicTacToexWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", TicTacToexWeb do
    ...
    live_session :current_user,
      on_mount: [{TicTacToexWeb.UserAuth, :mount_current_user}] do
  ...
  if Application.compile_env(:tic_tac_toex, :dev_routes) do
