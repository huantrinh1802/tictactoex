defmodule TicTacToexWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TicTacToexWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TicTacToexWeb.Gettext, "errors", msg, opts)
    end
  end
