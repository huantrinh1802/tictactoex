defmodule TicTacToex.Accounts.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, TicTacToex.Repo)
  ...
  defp maybe_validate_unique_name(changeset, opts) do
    if Keyword.get(opts, :validate_name, true) do
      changeset
      |> unsafe_validate_unique(:name, TicTacToex.Repo)
  ...
  """
  def valid_password?(%TicTacToex.Accounts.User{hashed_password: hashed_password}, password)
